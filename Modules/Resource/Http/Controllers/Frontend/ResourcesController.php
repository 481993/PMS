...
class ResourcesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(
            "resource::frontend.$module_path.index",
    ...
    public function show($id)
    {
        ...
        $posts = $$module_name_singular->posts()->with('category', 'resources', 'comments')->paginate();

        return view(
            "resource::frontend.$module_name.show",
