...
class Tasktype extends BaseModel
{
    ...
    /**
     * Get all of the posts that are assigned this tasktype.
     */
    public function posts()
    {
        return $this->morphedByMany('Modules\Article\Entities\Post', 'tasktypegable');
    }
    ...
    {
        return \Modules\Tasktype\Database\Factories\TasktypeFactory::new();
    }
}
