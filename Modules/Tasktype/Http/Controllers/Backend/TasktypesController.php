...
namespace Modules\Tasktype\Http\Controllers\Backend;
...
class TasktypesController extends BackendBaseController
{
    use Authorizable;
    ...
    {
        // Page Title
        $this->module_title = 'Task Types';

        // module name
        $this->module_name = 'tasktypes';

        // directory path of the module
        $this->module_path = 'tasktype::backend';
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route("backend.tasktypes.show", $$module_name_singular->id);
    }
