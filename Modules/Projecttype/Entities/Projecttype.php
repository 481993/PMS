...
class Projecttype extends BaseModel
{
    ...
    /**
     * Get all of the posts that are assigned this projecttype.
     */
    public function posts()
    {
        return $this->morphedByMany('Modules\Article\Entities\Post', 'projecttypegable');
    }
    ...
    {
        return \Modules\Projecttype\Database\Factories\ProjecttypeFactory::new();
    }
