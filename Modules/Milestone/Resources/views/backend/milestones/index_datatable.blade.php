        ...
        <div class="row">
            <div class="col-8">
                <h4 class="card-title mb-0">
                    <i class="{{ $module_icon }}"></i> <i class="fas fa-medal c-sidebar-nav-icon"></i> {{ $module_title }}
                ...
                $('#bidders').append('<tr><td>' +
                    ...
                    '</td><td>' + response[0][i][
                     ...
                     + '</td><td>' + pro_end_dt + '</td><td>' + response[0][i][
                        'hours'
                    ] + " Hrs</td><td>" + response[0][i][
                        'total_task'
                    ] + '</td><td>' + response[0][i]['milestone_weightage'] + '</td><td> <a href="milestones/' + response[0][i]["id"] +
