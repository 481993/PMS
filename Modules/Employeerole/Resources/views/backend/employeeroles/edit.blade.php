    ...
    <div class="card-body">
        <div class="row">
            <div class="col-8">
                ...
                <?php
                    if ($module_title   == 'Employeeroles') { ?>
                        <i class="{{ $module_icon }}"></i>  Employee Roles
                    <?php
                    } else { ?>
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        <div class="float-right">
                            ...
                            <a href="{{route("backend.$module_name.destroy", $$module_name_singular)}}" onclick="return confirm ('Are you sure to delete this record?');" class="btn btn-danger" data-method="DELETE" data-token="{{csrf_token()}}" data-toggle="tooltip" title="{{__('labels.backend.delete')}}"><i class="fas fa-trash-alt"></i></a>
                            @endcan
