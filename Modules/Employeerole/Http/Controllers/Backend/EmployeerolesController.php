...
namespace Modules\Employeerole\Http\Controllers\Backend;
...
class EmployeerolesController extends BackendBaseController
{
    use Authorizable;
    ...
    public function __construct()
    {
        ...
        $this->module_path = 'employeerole::backend';
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route("backend.employeeroles.show", $$module_name_singular->id);
    }
