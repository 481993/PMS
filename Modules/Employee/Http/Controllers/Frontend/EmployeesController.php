...
namespace Modules\Employee\Http\Controllers\Frontend;
...
class EmployeesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(
            "employee::frontend.$module_path.index",
    ...
    public function show($id)
    {
        ...
        $posts = $$module_name_singular->posts()->with('category', 'employees', 'comments')->paginate();

        return view(
            "employee::frontend.$module_name.show",
