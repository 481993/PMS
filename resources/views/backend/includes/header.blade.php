...
if(isset($user) && !empty($user) && $role_name[0]->name == 'manager')
{
//    print_r($user);
//     die();
?>
<style>
ul.c-sidebar-nav li:nth-child(2), ul.c-sidebar-nav li:nth-child(10), ul.c-sidebar-nav li:nth-child(11), ul.c-sidebar-nav li:nth-child(12) {
   display:none;
}
 </style>
<?php 
...
{{-- 
    ...
    <ul class="c-header-nav ml-auto mr-4">
        ...
        <li class="c-header-nav-item dropdown">
            <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                <div class="c-avatar">
                    <img class="c-avatar-img" src="{{ asset('img/default-avatar.jpg') }}" alt="{{ auth()->user()->name }}">
                </div>
            </a>
