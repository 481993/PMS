                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="float-right">
                                ...
                                <a href="{{route("backend.$module_name.destroy", $$module_name_singular)}}" class="btn btn-danger"  data-method="DELETE" data-token="{{csrf_token()}}"  onclick="return confirm ('Are you sure to delete this record?');" data-toggle="tooltip" title="{{__('labels.backend.delete')}}"><i class="fas fa-trash-alt"></i> Delete</a>
                                @endif
