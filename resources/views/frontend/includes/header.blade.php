    ...
    <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg headroom py-lg-3 px-lg-6 navbar-dark navbar-theme-primary">
        <div class="container">
            <a class="navbar-brand" href="/">
                <img class="navbar-brand-dark common" src="{{asset('img/iWork_5.svg')}}" height="35" alt="Logo light">
                <img class="navbar-brand-light common" src="{{asset('img/iWork_5.svg')}}" height="35" alt="Logo dark">
            </a>
            <div class="navbar-collapse collapse" id="navbar_global">
                <div class="navbar-collapse-header">
                    <div class="row">
                        <div class="col-6 collapse-brand">
                            <a href="/">
                                <img src="{{asset('img/iWork_5.svg')}}" height="35" alt="Logo Impact">
                            </a>
                        </div>
                ...
                <ul class="navbar-nav navbar-nav-hover justify-content-center">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle account-name" aria-expanded="false" data-toggle="dropdown">
                                ...
                                <div class="list-group list-group-flush">
                                    ...
                                    <a href="{{ route('login') }}"
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <span class="small">Login to the iWorks</span>
                                        </div>
                                    </a>
