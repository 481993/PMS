                        ...
                        <div class="row mt-4 mb-4">
                            <div class="col">
                                ...
                                <div class="form-group row">
                                    {{ html()->label(__('labels.backend.users.fields.password').'<span class="text-danger">*</span>')->class('col-md-3 form-control-label')->for('password') }}
                                    <div class="col-md-9">
                                ...
                                <div class="form-group row">
                                    {{ html()->label(__('labels.backend.users.fields.password_confirmation').'<span class="text-danger">*</span>')->class('col-md-3 form-control-label')->for('password_confirmation') }}
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <a href="{{ route("frontend.users.profileEdit", auth()->user()->username) }}" class="btn btn-warning" data-toggle="tooltip" title="{{__('labels.backend.cancel')}}"><i class="fas fa-reply"></i>&nbsp;Back</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
